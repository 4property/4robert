...
from services.publishing.social_delivery.gohighlevel_client import GoHighLevelApiError
...
class DatabaseJobDispatcher:
    def __init__(
        self,
        *,
        handler: Callable[[PropertyMediaJob], object | None],
...
def _build_property_video_job(claimed_job) -> PropertyMediaJob:
    ...
    return PropertyMediaJob(
        ...
        tenant=TenantContext(
            ...
            agency_id=claimed_job.agency_id,
            wordpress_source_id=claimed_job.wordpress_source_id,
        ),
