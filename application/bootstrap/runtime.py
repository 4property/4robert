...
from application.pipeline.content_generation import DeterministicPropertyContentGenerator
...
from application.pipeline.job_runner import PropertyMediaJobRunner
from application.pipeline.media_pipeline import PropertyMediaPipeline
...
def build_default_job_handler(
    ...
    *,
    database_locator: str | Path | None = None,
    pipeline: PropertyMediaPipeline | None = None,
) -> Callable[[PropertyMediaJob], object | None]:
    workspace_path = Path(workspace_dir).expanduser().resolve()
