...
from application.pipeline.content_generation import ContentGenerator, DeterministicPropertyContentGenerator
...
from settings import DEFAULT_PHOTOS_TO_SELECT, REVIEW_WORKFLOW_ENABLED, SELECTED_PHOTOS_DIRNAME
    ...
    def ingest_property(self, job: PropertyMediaJob) -> PropertyContext:
        ...
        with self.unit_of_work_factory() as unit_of_work:
            unit_of_work.property_repository.save_property_data(
                ...
                wordpress_source_id=job.tenant.wordpress_source_id,
                site_id=job.site_id,
            )
    ...
    def _build_ingested_pipeline_state(
        *,
        ...
        return PropertyPipelineState(
            ...
            wordpress_source_id=job.tenant.wordpress_source_id or state.wordpress_source_id,
            site_id=job.site_id,
            source_property_id=property_item.id,
            content_fingerprint=content_fingerprint,
            content_snapshot_json=content_snapshot_json,
    ...
    def _prepare_curated_assets(self, context: PropertyContext) -> PreparedMediaAssets:
        ...
        with self.unit_of_work_factory() as unit_of_work:
            unit_of_work.property_repository.save_property_images(
                ...
                wordpress_source_id=context.tenant.wordpress_source_id,
                site_id=context.site_id,
            )
...
class DefaultMediaRenderer(DefaultMediaRenderer):
    pass
...
class FileSystemMediaPublisher(FileSystemMediaPublisher):
    pass
...
class CompositeMediaPublisher(CompositeMediaPublisher):
    pass
