from config import DEFAULT_PHOTOS_TO_SELECT, PROPERTY_MEDIA_ROOT_DIRNAME, RAW_PHOTOS_DIRNAME, SELECTED_PHOTOS_DIRNAME
from services.property_media.downloads import download_property_images
