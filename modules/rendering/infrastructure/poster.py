...
<<<<<<< HEAD:services/media/reel_rendering/poster.py
from core.errors import PropertyReelError
<<<<<<< HEAD:services/reel_rendering/poster.py
...
from services.media.reel_rendering.runtime import resolve_ffmpeg_binary
from services.media.site_storage import (
>>>>>>> 7313fa1 (for change branch):services/media/reel_rendering/poster.py
=======
from shared.errors import PropertyReelError
from shared.storage.site_layout import (
>>>>>>> 2f106e7 (production test):modules/rendering/infrastructure/poster.py
