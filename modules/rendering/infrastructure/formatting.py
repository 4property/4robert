"""Property reel formatting helpers (text/wrap/price/size/overlay color).

Migrated from ``services/media/reel_rendering/formatting.py`` during
sub-feature 18c. Pure-compute helpers used by overlay layout, ffmpeg
filters, manifest writers and poster rendering.
"""
...
__all__ = [
<<<<<<< HEAD:services/media/reel_rendering/formatting.py
...
>>>>>>> 2f106e7 (production test):modules/rendering/infrastructure/formatting.py
]
