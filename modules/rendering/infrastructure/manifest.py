"""Property reel manifest builder.

Migrated from ``services/media/reel_rendering/manifest.py`` during
sub-feature 18c. Generates the JSON manifest that pairs each rendered
reel with its segment timing, slide selection, layout boxes and prepared
asset paths.
"""
