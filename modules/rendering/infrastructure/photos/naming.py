"""Filename helpers for property media downloads.

Migrated from ``services/media/property_media/naming.py`` during
sub-feature 18c. Pure-compute filename generation with sanitisation,
length-bounded shortening and primary-image suffix resolution.
"""
...
from settings import IMAGE_HEADERS
