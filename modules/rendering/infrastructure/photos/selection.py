"""Property image selection orchestrator.

Migrated from ``services/media/property_media/selection.py`` during
sub-feature 18c. Coordinates raw download, featured-image preparation,
Gemini classification and the staging-to-selected directory swap.
"""
...
from shared.observability import LoggedProcess, format_detail_line
from shared.errors import PhotoFilteringError
from modules.catalog.domain.wordpress_property import Property
from modules.reels.domain.types import DownloadedImage
from modules.rendering.infrastructure.ai_photo_selection import (
    GeminiImageRecord,
    classify_property_images,
)
from modules.rendering.infrastructure.photos.downloads import (
    download_image,
    download_images_to_directory,
    has_downloaded_images,
)
