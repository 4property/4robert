"""Property image downloader.

Migrated from ``services/media/property_media/downloads.py`` during
sub-feature 18c. Owns the HTTP fetch loop with progress logging plus the
per-property directory bootstrap.
"""
...
from settings import OUTBOUND_HTTP_TIMEOUT_SECONDS
from shared.observability import create_progress, format_detail_line, format_message_line
