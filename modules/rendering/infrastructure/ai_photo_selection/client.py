"""Gemini photo-selection HTTP client.

Migrated from ``services/ai/photo_selection/client.py`` during sub-feature
18c. Wraps the Gemini API for image classification with retry, quota
detection and JSON-shape validation.
"""
