...
Migrated from ``services/publishing/social_delivery/gohighlevel_client.py``
during sub-feature 18c. Wraps ``httpx`` with the GoHighLevel auth/version
headers and translates HTTP failures into ``SocialPublishingError``
subclasses.
"""
...
from shared.errors import SocialPublishingError, TransientSocialPublishingError
