"""GoHighLevel social-posting service.

Migrated from
``services/publishing/social_delivery/gohighlevel_social_service.py``
during sub-feature 18c. Wraps the social-media-posting endpoints
(accounts, location users, post create/get).
"""
