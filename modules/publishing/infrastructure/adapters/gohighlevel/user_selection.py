"""Fallback selectors for GoHighLevel location users.

Migrated from ``services/publishing/social_delivery/user_selection.py``
during sub-feature 18c.
"""
...
from modules.publishing.infrastructure.adapters.gohighlevel.models import LocationUser
