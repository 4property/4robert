"""Platform policy lookups + per-platform validation.

Migrated from
``services/publishing/social_delivery/platform_policy.py`` during
sub-feature 18c. Reads ``modules.publishing.infrastructure.adapters.platforms``
configuration to compute caption/upload constraints.
"""
