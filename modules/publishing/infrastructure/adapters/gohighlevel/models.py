"""GoHighLevel publishing dataclasses + request envelopes.

Migrated from ``services/publishing/social_delivery/models.py`` during
sub-feature 18c. Owns the value objects exchanged with the GoHighLevel
adapter (accounts, location users, uploaded media, request/result
envelopes for single and multi-platform publishes).
"""
