"""GoHighLevel media upload service.

Migrated from
``services/publishing/social_delivery/gohighlevel_media_service.py``
during sub-feature 18c. Uploads property reels and posters to the
GoHighLevel /medias endpoint with size-class validation.
"""
...
from shared.errors import ResourceNotFoundError, SocialPublishingError, ValidationError
