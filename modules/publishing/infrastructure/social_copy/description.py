"""Platform-aware property description builders.

Migrated from ``services/publishing/social_delivery/description.py``
...
from modules.rendering.infrastructure.data import PropertyReelRecord
